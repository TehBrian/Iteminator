...
public final class LowerBooleanArgument<C> extends CommandArgument<C, Boolean> {

    private final boolean liberal;

    private LowerBooleanArgument(
    ...
    public static <C> @NonNull CommandArgument<C, Boolean> of(final @NonNull String name) {
        return LowerBooleanArgument.<C>newBuilder(name).asRequired().build();
    }
    ...
    public static <C> @NonNull CommandArgument<C, Boolean> optional(final @NonNull String name) {
        return LowerBooleanArgument.<C>newBuilder(name).asOptional().build();
    }
    ...
    public static <C> @NonNull CommandArgument<C, Boolean> optional(
        ...
        return LowerBooleanArgument.<C>newBuilder(name).asOptionalWithDefault(Boolean.toString(defaultBoolean)).build();
    }
    ...
    public static final class Builder<C> extends CommandArgument.Builder<C, Boolean> {
         ...
         */
        @Override
        public @NonNull LowerBooleanArgument<C> build() {
            return new LowerBooleanArgument<>(
                    this.isRequired(),
                    this.getName(),
                    this.liberal,
